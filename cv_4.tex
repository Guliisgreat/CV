...
\\
{\em Department of Electrical and Computer Engineering}\hfill {Sep 2016 - June 2018}\\
\vspace*{-.1in}
\begin{list}
\item[] M.Eng Student, Focus: Machine Learning
\end{list}

{\bf Shanghai Jiaotong University} \hfill {Sep 2011 - Sep 2015}
\\
...
Skills & Python, C++, Matlab \\& Pytorch, Tensorflow, Caffe2 \\& AWS, Cuda, MySQL\\

Courses & Machine Learning, Probabilistic Graphical Model, Random Process, \\&Computer Vision, 
Machine Learning in Sports Analysis, Bayesian Deep Learning
