...
\usepackage[left=0.4 in,top=0.2 in,right=0.4 in,bottom=0.1 in]{geometry} % Document margins
...
\\
M.Eng. in Computer Engineering, GPA 90/100

{\bf Deep Learning Summer School} \hfill {July 2017, August 2018}
\\
{\em University of Montreal, University of Toronto}

{\bf Shanghai Jiaotong University}
\\
{\em Department of Electrical and Computer Engineering}\hfill {September 2011 - July 2015}
\\
BASc. in Communication Engineering
...
Skills & Python, PyTorch, Tensorflow, Matlab, CUDA, C++, AWS\\

Courses & Machine Learning, Foundations of Computer Vision, Deep Learning in Computer Vision,\\& 
Bayesian Deep Learning, Random Process, GPU Programming
...
\begin{rSection}{ Publication } \itemsep -3pt        
 ...
 {Adversarial Distillation of Bayesian Neural Network Posteriors. Kaun-Chieh Wang, Paul Vicol, James Lucas, \textbf {Li Gu}, Richard Zemel, Roger Grosse. \textit{Proceedings of the 35th International Conference on Machine Learning, PMLR 80:5190-5199, 2018.}}

 {Graph-based Efficient WiFi Fingerprint Training Using Un-supervised Learning. Bo Zhao, Ling Pei, Changqing Xu, \textbf {Li Gu}. \textit{Proceedings of the 28th International Technical Meeting of The Satellite Division of the Institute of Navigation (ION GNSS+ 2015)}}
...
\item Proposed an end-to-end framework including Mask R-CNN, FlowNet, custom matching and refine modules on video multiple objects segmentation 
\item Exploited several modifications on Mask R-CNN such as deformable convolution, heavier box head, balanced cross entropy loss , which achieved 1.25x improvements on per-frame instance segmentation on DAVIS2017 
\item In preparation for \textit{ICCV 2019}
...
\item Proposed a framework to distill MCMC samples from Stochastic Gradient Langevin Dynamics (SGLD) using a Generative Adversarial Netork (GAN), which reduces the storage overhead involved in maintaining MCMC samples without loss in performance
\item Implemented an optimitzer called SGLD on Bayesian Neural Networks with PyTorch
\item Conducted experiments on several Bayesian Neural Networks applications including classification, anomaly detection, active learning
\item Accepted to \textit{ICML 2018}
